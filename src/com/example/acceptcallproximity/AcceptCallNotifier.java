...
public class AcceptCallNotifier {
        ...
        public AcceptCallNotifier(Context context) {
                mContext = context;
        ...
        private void enableNotification() {
                ...
                Intent notificationIntent = new Intent(mContext, AcceptCallPreferenceActivity.class);
